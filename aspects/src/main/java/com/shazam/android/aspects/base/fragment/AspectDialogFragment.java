...
import com.shazam.android.aspects.dispatchers.fragment.AspectDialogFragmentDispatcher;
 ...
 */
public class AspectDialogFragment extends DialogFragment {
    private AspectDialogFragmentDispatcher dispatcher;

    @SuppressWarnings("UnusedDeclaration")
    public AspectDialogFragment() {
        this.dispatcher = AspectDialogFragmentDispatcher.create(this);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return dialog != null ? dialog : dispatcher.dispatchOnCreateDialog(this, savedInstanceState);
    }
